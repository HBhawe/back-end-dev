...
app.post("/submit", (req, res) => {
  ...
  let adjValue = adj[Math.floor(Math.random() * adj.length)];
  let nounValue = noun[Math.floor(Math.random() * noun.length)];
  res.render("index.ejs", { adjective: adjValue, noun: nounValue });
});
